...
//  Diagnose Me
//
//  Created by Luke Porupski on 4/24/17.
//  Copyright © 2017 Luke Porupski. All rights reserved.
//

import UIKit

class DiagnosisTableViewController: UITableViewController, DataHandlerDiagnosisViewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        if let dh = self.dataHandler {
            dh.diagnosisViewDelegate = self
            dh.diagnoseForSymptoms(symptoms: symptoms)
        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        rowData = diagnoses[indexPath.row]
